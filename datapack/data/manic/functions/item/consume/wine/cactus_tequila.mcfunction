...
execute if score @s manic.sanity matches ..5555 run scoreboard players add @s manic.sanity 555
execute if score @s manic.sanity matches 5555.. run scoreboard players remove @s manic.sanity 150

...
execute unless score #sanguine.blood_moon sanguine.dummy matches 1 unless score @s manic.has_slept_today matches 1 run scoreboard players add @s manic.sanity 350

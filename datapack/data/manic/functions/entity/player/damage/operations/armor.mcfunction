...
# #damage manic.dummy: damage to add to entity, to 1 decimal place (x10)
 ...
 ## Insert Armor Toughness
  ...
  # This leads to armor ÷ 5 being stored in manic.temp_2
scoreboard players operation #temp_2 manic.dummy = #temp_0 manic.dummy
scoreboard players operation #temp_2 manic.dummy /= #5 manic.dummy
 ...
 ##### SEPARATOR SO YOUR BRAIN DOESN'T MELT
  ...
  # Armor
scoreboard players operation #temp_3 manic.dummy = #temp_0 manic.dummy
  # Damage
scoreboard players operation #temp_4 manic.dummy = #damage manic.dummy
  # Armor Toughness
scoreboard players operation #temp_5 manic.dummy = #temp_1 manic.dummy


  # Divide by 4 (working inside -> out), so (toughness ÷ 4) first.
  # #4 always has the value of 4.

scoreboard players operation #temp_5 manic.dummy /= #4 manic.dummy


  # Then we add 2 to that, again working inside -> out. (2 + (toughness ÷ 4))

scoreboard players add #temp_5 manic.dummy 20


  # Then, divide the damage by that value. (damage ÷ (2 + (toughness ÷ 4)))

scoreboard players operation #temp_4 manic.dummy /= #temp_5 manic.dummy
scoreboard players operation #temp_4 manic.dummy *= #10 manic.dummy

  # Then subtract that value from armor, and you have the final result of the armor toughness formula.

scoreboard players operation #temp_3 manic.dummy -= #temp_4 manic.dummy
 ...
 # manic.temp_2 = armor ÷ 5
 # manic.temp_3 = Armor Toughness Formula results

execute if score #temp_3 manic.dummy > #temp_2 manic.dummy run scoreboard players operation #temp_2 manic.dummy = #temp_3 manic.dummy


 # Then the next part, the min(20, max(whatever was in last step)). If >20, it equals 20.
 # manic.temp_2 = The results from last step, carried over.

execute if score #temp_2 manic.dummy matches 200.. run scoreboard players set #temp_2 manic.dummy 200
...
scoreboard players operation #temp_2 manic.dummy *= #10 manic.dummy
  # Divide by 25 per the formula
scoreboard players operation #temp_2 manic.dummy /= #25 manic.dummy

  # Then subtract it all from 1 (100)

scoreboard players set #temp_0 manic.dummy 100
scoreboard players operation #temp_0 manic.dummy -= #temp_2 manic.dummy

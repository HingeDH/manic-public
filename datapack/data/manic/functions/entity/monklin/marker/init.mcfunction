...
execute at @s unless entity @p[distance=..4] run function manic:commands/summon/monklin
execute at @s unless entity @p[distance=..4] run scoreboard players set #manic.monklin manic.dummy 240
kill @s[type=marker]
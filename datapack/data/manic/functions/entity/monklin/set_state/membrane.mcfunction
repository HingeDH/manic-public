...
data modify entity @s ArmorItems[3].tag.manic.custom_model_data.idle set value 8360045
data modify entity @s ArmorItems[3].tag.manic.custom_model_data.moving set value 8360045

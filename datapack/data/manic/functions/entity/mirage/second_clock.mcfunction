...
execute if score @s manic.dummy matches 7..9 if predicate manic:chance/one_fourth run function manic:entity/mirage/shootfacing
execute if score @s manic.dummy matches 10 run function manic:entity/mirage/shootfacing

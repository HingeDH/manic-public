execute if entity @s[tag=manic.block.corpsebloom] run function manic:block/corpsebloom/interact/as_entity
execute if entity @s[tag=manic.block.corpsepitcher] run function manic:block/corpsepitcher/interact/as_entity
execute if entity @s[tag=manic.block.corpsegourd] run function manic:block/corpsegourd/interact/as_entity

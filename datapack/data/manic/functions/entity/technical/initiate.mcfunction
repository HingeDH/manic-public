execute if entity @s[tag=manic.block.corpsebloom.start] run function manic:block/corpsebloom/place/initiate
execute if entity @s[tag=manic.block.corpsepitcher.start] run function manic:block/corpsepitcher/place/initiate
execute if entity @s[tag=manic.block.corpsegourd.start] run function manic:block/corpsegourd/place/initiate

...
execute if entity @s[tag=manic.entity.mirage] run playsound manic:entity.mirage.ambient hostile @a
execute if entity @s[tag=manic.entity.corpsecreep] run playsound manic:entity.corpsecreep.ambient hostile @a